...
-- I couldn't do the assignment before as I did not follow this well in class, 
-- I didn't understand the concept, after walking through the solution and clearing some doubts in the TA hours 
-- I was able to understand and complete this today 
...
barExp = Abs (app4 case3 
                    ...
                    (Abs (app2 add (App fst (Ref 0)) (app3 if_ (App snd (Ref 0)) one zero))) 
                    (Ref 0))
